...
export function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#5B68F0] via-[#6B76F5] to-[#7B84FA] flex flex-col relative overflow-hidden w-full max-w-[600px] mx-auto">
      ...
      {/* 로그인 버튼 영역 */}
      <div className="bg-white rounded-t-[32px] px-6 sm:px-8 py-8 sm:py-10 pb-10 sm:pb-12">
        <div className="flex justify-center gap-4 sm:gap-6 mb-6">
          {/* 카카오 로그인 */}
          <button
            onClick={handleKakaoLogin}
            className="w-14 h-14 bg-[#FEE500] hover:bg-[#FEE500]/90 rounded-full flex items-center justify-center shadow-lg touch-manipulation transition-all"
          >
          ...
          <button
            ...
            className="w-14 h-14 bg-white hover:bg-gray-50 rounded-full flex items-center justify-center shadow-lg border-2 border-gray-200 touch-manipulation transition-all"
          >
        ...
        <p className="text-center text-[14px] sm:text-[15px] text-gray-900 font-medium">전화 문의</p>
      </div>
    </div>
  )
}
